...
Finally, we get to the core of calibration, the **curve-fitting** step, again using the O'Connell's ELISA data. This first example of curve-fitting and derivation of the inverse model is long because the steps in the analysis are explained in greater detail than in later examples. 
